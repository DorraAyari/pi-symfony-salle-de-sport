 ...
 */
final class Version20230215202707 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE blog ADD image VARCHAR(255) NOT NULL, ADD created_at DATETIME NOT NULL, DROP date');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE blog ADD date DATE NOT NULL, DROP image, DROP created_at');
