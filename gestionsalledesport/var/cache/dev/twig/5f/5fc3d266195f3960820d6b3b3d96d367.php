...
/* blog/blog.html.twig */
class __TwigTemplate_8c0742bcd2c3da353fa47044ddbd0c92 extends Template
{
    private $source;
    private $macros = [];
    ...
    <section class=\"blog-section spad\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["blog"]) {
            ...
            echo "\"/>
                         ...
                         <div class=\"bi-text\">
                            <h3 style=\"color: white;\"><a href=\"";
            // line 44
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("detailsblog", ["id" => twig_get_attribute($this->env, $this->source, $context["blog"], "id", [], "any", false, false, false, 44)]), "html", null, true);
            echo "\">";
...
";
    ...
    {
        return array (  155 => 61,  153 => 60,  140 => 52,  138 => 51,  134 => 49,  129 => 47,  121 => 44,  113 => 41,  108 => 38,  104 => 37,  97 => 32,  95 => 31,  68 => 5,  58 => 4,  35 => 1,);
    }
                ...
                {% for blog in blog %}
                    <div class=\"blog-item\">
                        ...
                        <div class=\"bi-pic\">
                         ...
                         <div class=\"bi-text\">
                            <h3 style=\"color: white;\"><a href=\"{{path('detailsblog',{ id:blog.id})}}\">{{ blog.nom }}</h3>
                            <ul>
                                <li>by Admin</li>
...
{% endblock %}", "blog/blog.html.twig", "C:\\Users\\EMNA\\Documents\\GitHub\\pi\\gestionsalledesport\\templates\\blog\\blog.html.twig");
    }
}
