 ...
 <div class=\"row\">
    ...
    <table class=\"table\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["member"]) {
            ...
            // line 52
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("modifierpack", ["id" => twig_get_attribute($this->env, $this->source, $context["member"], "id", [], "any", false, false, false, 52)]), "html", null, true);
            echo "\" > modifier </a></td>
        ...
        {% for member in members %}
            <tr>
                ...
                <td>
                    ...
                    <td><a class=\"btn btn-success\" href=\"{{path('modifierpack',{ id:member.id}      ) }}\" > modifier </a></td>
...
{% endblock  %}", "member/index.html.twig", "C:\\Users\\AA\\PI1\\pi\\gestionsalledesport\\templates\\member\\index.html.twig");
    }
}
