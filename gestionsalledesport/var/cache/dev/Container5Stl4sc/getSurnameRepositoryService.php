 ...
 */
class getSurnameRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SurnameRepository' shared autowired service.
     *
     * @return \App\Repository\SurnameRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SurnameRepository.php';

        return $container->privates['App\\Repository\\SurnameRepository'] = new \App\Repository\SurnameRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
