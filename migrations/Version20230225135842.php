 ...
 */
final class Version20230225135842 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commentaire (id INT AUTO_INCREMENT NOT NULL, blogid_id INT DEFAULT NULL, parent_id INT DEFAULT NULL, comment VARCHAR(255) NOT NULL, INDEX IDX_67F068BCC2B162DC (blogid_id), INDEX IDX_67F068BC727ACA70 (parent_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
